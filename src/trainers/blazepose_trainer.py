...
def train(config):
    ...
    # test gt input and gt label

    # for img,lablel in train_dataset:
    #     print('test.')
...
def quantization_aware_training(config):
    """Train model
    ...
    q_aware_model.compile(optimizer=tf.optimizers.SGD(train_config["learning_rate"], momentum=0.9),
